...
// find By Id And Update
 ...
 await connectToDatabase()
    try {
        ...
        switch (req.method) {
            case 'PUT':
                const { name, price, status, location,category,badges ,startcity,uploads, selectedState,
                ...
                updatedPackage = await Package.findByIdAndUpdate(packageId, { name, price, status, location,category,badges,startcity:startcity1,uploads:images,country:selectedCountry,state:selectedState,packageRating,highlightedPackage }, { new: true });
