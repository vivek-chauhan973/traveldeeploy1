      ...
      <div className=" mt-10 container-wrapper md:pt-20 md:px-2 md:relative py-3 px-3  md:gap-3 bg-gray-400   md:flex ">
        ...
        <div className=" md:w-72 md:h-3/5  w-full border md:mt-7 mt-14 rounded-lg  bg-white ">
          ...
          <div className=" mt-20 ml-5 ">
            <h1 className="md:font-medium  fonrt-semibold text-gray-300 md:text-lg  text-md">
              Chauhan jee
            </h1>
          ...
          <div className=" md:mt-7 md:py-3 md:ml-5  md:block hidden">
            <div className="flex">
              <span>
                {" "}
                <FaUser size={30} onClick={handleAccount} />
              </span>
            ...
            <div className="mt-6 py-3 ">
              <div className="  justify-center  bg-[#ffff] md:w-[700px] w-full shadow-sm rounded-lg p-5  ">
                <div className=" flex    justify-between ">
                  <h1 className="font-bold text-[20px]">My Profile</h1>
                  <span
                    className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-[#F3F3F3] text-black "
                    onClick={btnChange}
                  >
                    {plus ? <FiMinus /> : <FaPlus />}
                  </span>
