...
import FlightBooking from "@/components/admin/itineraryCreate/CarFlightBooking";
...
import CarPricingManagementPopup from "@/components/admin/itineraryCreate/CarPricingManagementPopup";
import CarPricingManagement from "@/components/admin/itineraryCreate/CarPricingManagement";
            ...
            <Layout>
                ...
                <div className={` ${activeTab === 'Tab9' ? 'block' : 'hidden'}`}>
                    <div className="relative">
                        {itinerary?.prices === null && pricingPopup && <CarPricingManagementPopup setPricingPopup={setPricingPopup} handleOnChange={handleOnChange} handleCheckbox={handleCheckbox} />}
                        {(itinerary?.prices?.addguest === "addGuest" || selectedOption === "addGuest") && (
                            <CarPricingManagement itinerary={itinerary} setActiveTab={setActiveTab} setPriceManagementDot={setPriceManagementDot} setCalendarPricemanagement={setCalendarPricemanagement}/>
                        )}
                        {(itinerary?.prices?.departure1 === "fixedDeparture" || selectedOption === "fixedDeparture") && (
                            <div>
                                <p><CarFixedDeparture  itinerary={itinerary} setActiveTab={setActiveTab} setPriceManagementDot={setPriceManagementDot} /></p>
