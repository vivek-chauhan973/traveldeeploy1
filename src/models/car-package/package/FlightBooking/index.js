...
const CarFlightBookingSchema = mongoose.models.CarFlightBooking || mongoose.model('CarFlightBooking', flightBookingSchema);



export default CarFlightBookingSchema;