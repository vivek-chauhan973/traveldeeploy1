...
//                       <p className="font-semibold text-lg">Transports</p>
//                       <div className="flex items-center  gap-4">
//                         <button
//                           onClick={handleToggle}
//                           className={`px-6  py-2 rounded-l-full text-sm md:text-lg transition-all ${
//                             isAC
...
//                         <button
//                           onClick={handleToggle}
//                           className={`px-6 md:py-2 py-2 rounded-r-full text-sm md:text-lg transition-all ${
//                             !isAC
        ...
        >
          <form className="w-full" action="">
            <div>
              <div className="relative  md:mt-0 mt-14 ">
                <div className="sticky top-0 shadow-md z-[5]">
                  <div className="flex justify-between px-3 items-center py-4  md:px-[2vw] bg-white z-10">
                    <p className=" capitalize  text-para md:text-md font-semibold">
                      add guest & Choose from{}
                    </p>
                    <div>
                      <p className="text-lg font-medium"> ₹ {guestPrice}</p>
