...
const LimitedTime = () => {
  ...
  const fetchGroups = async () => {
    try {
      const response = await fetch(
        "/api/cars/package/terms-condition/LimitedTime/get"
      );
  ...
  const handleDelete = async () => {
    if (deleteGroupId) {
      try {
        const response = await fetch(
          "/api/cars/package/terms-condition/LimitedTime/delete",
          {
            method: "POST",
  ...
  const handleSave = async () => {
    const url = isEditing
      ? "/api/cars/package/terms-condition/LimitedTime/edit"
      : "/api/cars/package/terms-condition/LimitedTime/add";
