...
const CarNeedToKnow = () => {
    ...
    const fetchGroups = async () => {
        try {
            const response = await fetch('/api/cars/package/tour-info/need-to-know/get');
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/cars/package/tour-info/need-to-know/delete', {
                    method: 'POST',
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/cars/package/tour-info/need-to-know/edit'
            : '/api/cars/package/tour-info/need-to-know/add';
            ...
            <div className="md:flex gap-5">
                <div className=" grow border rounded p-4 h-72">
                    <div className='flex flex-col'>
                        <label className="pb-2 font-semibold">Tour Need To Know</label>
