...
const CarChartureTerm = () => {
    ...
    const fetchGroups = async () => {
        try {
            const response = await fetch('/api/cars/package/terms-condition/chartureTerm/get');
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/cars/package/terms-condition/chartureTerm/delete', {
                    method: 'POST',
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/cars/package/terms-condition/chartureTerm/edit'
            : '/api/cars/package/terms-condition/chartureTerm/add';
...
export default CarChartureTerm;
