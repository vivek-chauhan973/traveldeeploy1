...
const CarTourExclusion = () => {
    ...
    const fetchGroups = async () => {
        try {
            const response = await fetch('/api/cars/package/tour-info/exclusion/get');
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/cars/package/tour-info/exclusion/delete', {
                    method: 'POST',
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/cars/package/tour-info/exclusion/edit'
            : '/api/cars/package/tour-info/exclusion/add';
...
export default CarTourExclusion;
