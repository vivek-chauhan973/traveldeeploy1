...
const FlexibleTime = () => {
  ...
  const fetchGroups = async () => {
    try {
      const response = await fetch(
        "/api/cars/package/terms-condition/FlexibleTime/get"
      );
  ...
  const handleDelete = async () => {
    if (deleteGroupId) {
      try {
        const response = await fetch(
          "/api/cars/package/terms-condition/FlexibleTime/delete",
          {
            method: "POST",
  ...
  const handleSave = async () => {
    const url = isEditing
      ? "/api/cars/package/terms-condition/FlexibleTime/edit"
      : "/api/cars/package/terms-condition/FlexibleTime/add";
