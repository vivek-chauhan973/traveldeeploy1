...
const PackageTerm = () => {
  ...
  const handleDelete = async () => {
    if (deleteGroupId) {
      try {
        const response = await fetch(
          "/api/package/terms-condition/packageTerm/delete",
          {
            method: "POST",
  ...
  const handleSave = async () => {
    const url = isEditing
      ? "/api/package/terms-condition/packageTerm/edit"
      : "/api/package/terms-condition/packageTerm/add";
