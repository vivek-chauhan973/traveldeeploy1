...
const GroupDepartureTerm = () => {
    ...
    const fetchGroups = async () => {
        try {
            const response = await fetch('/api/package/terms-condition/GroupDepartureTerm/get');
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/package/terms-condition/GroupDepartureTerm/delete', {
                    method: 'POST',
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/package/terms-condition/GroupDepartureTerm/edit'
            : '/api/package/terms-condition/GroupDepartureTerm/add';
...
export default GroupDepartureTerm;
