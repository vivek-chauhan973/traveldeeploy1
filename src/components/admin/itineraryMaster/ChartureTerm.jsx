...
const ChartureTerm = () => {
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/package/terms-condition/chartureTerm/delete', {
                    method: 'POST',
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/package/terms-condition/chartureTerm/edit'
            : '/api/package/terms-condition/chartureTerm/add';
