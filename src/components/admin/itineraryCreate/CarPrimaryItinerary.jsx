...
const CarPrimaryItinerary= ({setActiveTab, itinerary,setBasicDot })=> {
  ...
  useEffect(()=>{
    ...
    useEffect(() => {
        ...
        setSelectedCarName(itinerary?.selectedCarName);
                    ...
                    <div className="border p-4 rounded">
                        <div>
                            ...
                            <div className=" sm:flex items-center mb-4">
                                ...
                                <input ref={packageTitleRef} type="text" className='  border w-full  rounded-md h-8 px-2 focus:border-primary outline-none text-para'
                                    onChange={(e) => handlePackageTitle(e.target.value)} placeholder="Enter package name" defaultValue={itinerary?.name} />
                            </div>
                            <div className=" sm:flex items-center">
                                <label htmlFor="selectedCarName" className=" font-semibold w-32 text-para">Select Vichel:</label>
                                ...
                                <option value="">{selectedCarName||"Select Car Title"}</option>
