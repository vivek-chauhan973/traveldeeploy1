...
const CarPricingManagement = ({ itinerary, setActiveTab ,setPriceManagementDot, setCalendarPricemanagement}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (hasError) {
            ...
            try {
                const res = await fetch(`/api/cars/package/price/addguests/${itinerary?._id}`, {
                    method: 'POST',
                    headers: {
