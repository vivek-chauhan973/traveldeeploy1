        ...
        <>
            <div className="bg-white rounded p-3">
                ...
                <div className="border p-4 rounded mb-2 overflow-scroll">
                    <div className=" sm:flex items-center md:mb-3.5 mb-2">
                    ...
                    <div className=" sm:flex items-center md:mb-2.5 mb-2">
                    ...
                    <div className=" sm:flex items-center">
                        <label htmlFor="svg" className=" font-semibold w-36 text-para">SVG Icon :</label>
