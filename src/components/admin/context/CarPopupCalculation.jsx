...
export const CarPopupProvider = ({ children }) => {
  ...
  console.log("userPlanOutstation global",userPlanOutstation);
  ...
  const contextFun = {
    ...
    pickupDateOutstation, returnDateOutstation, pickupTimeOutstation, returnTimeOutstation,  userPlanOutstation,
    setPickupDateOutstation, setReturnDateOutstation, setPickupTimeOutstation, setReturnTimeOutstation, setUserPlanOutstation
