            ...
            <div className="sticky top-[50px] z-20">
              <div className="flex gap-1 justify-center items-center">
                <div className="items-center flex flex-col p-2 ml-10 text-center">
                  <span>
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="bi bi-whatsapp curor-pointer"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="border-l h-full items-center flex flex-col p-2 text-center">
                  <FontAwesomeIcon icon={faPrint} className="font1 curor-pointer" />

                  <p className="text-[12px] curor-pointer">Share Itinerary</p>
                </div>
                <div className="border-l h-full items-center flex flex-col p-2 text-center">
                  <FontAwesomeIcon icon={faEnvelope} className="font1 curor-pointer" />

                  <p className="text-[12px] curor-pointer">Email Itinerary</p>
                </div>
              </div>
              {/* card is here */}
              <ItinerarySideCard />
