...
const TestingCard = ({ addPackage }) => {
    ...
    console.log("suggsted package123",suggestedPackage)
                    ...
                    >
                        <div className="relative mx-4 mt-4 overflow-hidden text-white rounded-md bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                            <Image
                                ...
                                src={item?.uploads?.[0]?item?.uploads?.[0]:"https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1470&amp;q=80"}
