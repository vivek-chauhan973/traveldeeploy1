...
const fetchSuggestedData = async (addPackage) => {
  const res = await fetch(`/api/blog/suggestedposts?packageId=${addPackage?._id}`);
                ...
                >
                  ...
                  <div className="px-6 py-3">
                    ...
                    <div className='line-clamp-2'>
                      ...
                      <p dangerouslySetInnerHTML={{ __html: item?.about }} className="block font-sans text-para text-gray-700"></p>
                    </div>
...
export default BlogSuggestedCardPackages;
