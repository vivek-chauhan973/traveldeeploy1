    ...
    return (
        <>
            <div className="flex items-center gap-5 text-primary xl:my-10 mb-5">
                ...
                <p className="md:text-[28px] text-xl text-black">Static Banner Management</p>
                <FontAwesomeIcon
            ...
            <div className="bg-white p-5 rounded-md mb-10">
                ...
                <div className="grid md:grid-cols-2 border-b-2 border-gray-100">
                    <div>
                        <p className="md:text-lg text-base font-semibold">Static Banner Image</p>
                    ...
                    {formData?.image && (
                        <div>
                            <p className="md:text-lg text-base font-semibold">Static Banner Data</p>
                            <div className="py-5">
