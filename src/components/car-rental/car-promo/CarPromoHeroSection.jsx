    ...
    <div className="mb-6">
      <div className="relative w-full h-80 md:h-96 lg:h-[28rem] overflow-hidden">
          ...
          <div className="box-Shadow-Style-Package  justify-end  gap-3  absolute z-10 w-full  py-5  bottom-0 ">
            <h1 className="absolute uppercase font-bold xl:text-[38px] md:text-[32px] text-xl italic md:bottom-5 bottom-2 xl:right-16 md:right-5 right-4 text-white">{"Car Promo"}</h1>
          </div>
      </div>
...
export default CarPromoHeroSection;
