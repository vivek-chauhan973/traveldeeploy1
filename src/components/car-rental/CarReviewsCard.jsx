        ...
        <div className=" bg-[#E7E7E7]"> {/* bg-cyan-950 */}
            <div className="carousel-container relative container-wrapper ">
                ...
                <div className="carousel gap-5 pb-10"
                    ...
                    <div
                        // key={index}
                        className="bg-white min-w-80 rounded-lg mb-4">
                        ...
                        <div className="px-3 py-1">
                            ...
                            <p className="mt-1 text-para line-clamp-3">
                                {/* {item.information} */}
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Impedit voluptate, corporis unde corrupti dolores rem accusamus neque aliquam tempore deserunt
                                cumque explicabo quae maxime non laudantium.  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Impedit voluptate, corporis unde corrupti dolores rem accusamus
                                neque aliquam tempore deserunt cumque explicabo quae maxime non laudantium.
                            </p>
                            <button
                    ...
                    <div className="bg-white min-w-80 rounded-lg mb-4">
                        <div className="flex justify-between items-center px-4 mt-4">
                            <div className="p-1 flex items-center gap-1">
                                <FontAwesomeIcon
                                    icon={faStar}
                        ...
                        <div className="px-3 py-1">
                            ...
                            <button className="text-blue-500 text-para">read more..</button>
                        </div>
                        <hr />
                        <div className="flex justify-between px-4 py-2 text-para">
                            <span className="font-bold capitalize text-gray-700"> Rakesh Kumar Rikki</span>
